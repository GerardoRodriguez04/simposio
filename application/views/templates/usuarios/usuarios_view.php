	       ...
	       <div class="iq-header-title">
				<div class="row">
	                <div class="col-sm-12 col-md-12">
            			...
            			<?php if(have_permission('Usuarios-Add')){ ?>      
	          			<a href="<?= base_url(); ?>Usuarios/form_view/0" class="btn mb-6 btn-warning" style="background: #d05400 !important; color: white !important; border: 1px #d05400 !important;"><i class="ri-add-circle-fill"></i> Agregar</a>
	          			<?php } ?>
              			<?php if(have_permission('Reportes-Ver')){ ?>      
						<a class="btn btn-info" href="<?= base_url(); ?>Usuarios/reporte_excel" style="margin-left: 4px;">
						  <i class="fa fa-list-ol" aria-hidden="true"></i> Reporte usuarios
						</a>
						<?php } ?>
	          		</div>
	          	</div>
