			...
			if(res != ''){
				...
				for (var i = 0; res['notificaciones']['comentario_id'].length > i; i++) {
					...
					$('.div-notificaciones').append(
						'<a href="'+base_url+'Solicitudes/detalles_view/'+res['notificaciones']['solicitud_id'][i]+'" class="iq-sub-card comentario-solicitud '+bg+'" data-toggle="tooltip" data-placement="top" title="'+res['notificaciones']['comentario'][i]+'">'
